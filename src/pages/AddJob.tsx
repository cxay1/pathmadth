...
const AddJob: React.FC = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      // Filter out empty skills and benefits
      const filteredData = {
        ...formData,
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="w-full px-4 py-3 border-2 border-dashed border-gray-300 rounded-lg text-gray-600 hover:border-red-400 hover:text-red-600 transition-colors"
                >
                  + Add Skill
                </button>
              </div>
                ...
                {formData.benefits.map((benefit, index) => (
                  <div key={index} className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent transition-colors"
                      placeholder="e.g., Health insurance, 401(k) matching, Remote work"
                    />
